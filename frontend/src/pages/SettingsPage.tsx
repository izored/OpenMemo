    ...
    <div className="max-w-2xl mx-auto pt-8 pb-20">
      ...
      <section className="mb-12">
        ...
        <div className="bg-[var(--color-bg-card)] rounded-3xl p-8 shadow-sm">
          <h3 className="text-lg font-bold text-[var(--color-text)] mb-1">Background Color</h3>
          ...
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-4">
            {bgPresets.map((preset) => (
              ...
              >
                ...
                >
                  {bgColor === preset.value && (
                    <Check size={20} className="text-[var(--color-text)]" />
                  )}
                </div>
                <span
                  className={cn(
                    'text-[13px] font-semibold transition-colors',
                    bgColor === preset.value ? 'text-[var(--color-text)]' : 'text-[var(--color-text-muted)]'
                  )}
                >
                  {preset.name}
                </span>
