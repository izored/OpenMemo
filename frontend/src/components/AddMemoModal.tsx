    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-lg mx-4 overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-[#E5E7EB]">
          <h2 className="text-lg font-semibold text-[#1F2937]">Add New Memo</h2>
          <button onClick={close} className="p-1 rounded-lg hover:bg-[#F3F4F6]">
        ...
        <div className="p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2.5 border border-[#E5E7EB] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#D97706]/20 focus:border-[#D97706]"
              ...
              <button
                ...
                className="w-full py-2.5 bg-[#D97706] text-white rounded-lg text-sm font-medium hover:bg-[#B45309] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
          ...
          {activeTab === 'note' && (
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-[#374151] mb-1.5">Content</label>
                <textarea
                  value={noteContent}
                  onChange={(e) => setNoteContent(e.target.value)}
                  placeholder="Write your note here... (Markdown supported)"
                  rows={6}
                  className="w-full px-3 py-2.5 border border-[#E5E7EB] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#D97706]/20 focus:border-[#D97706] resize-none"
                />
              </div>
              <button
            ...
            <div className="space-y-4">
              <div
                ...
                className={cn(
                  ...
                  dragOver ? 'border-[#D97706] bg-[#FEF3C7]' : 'border-[#E5E7EB] hover:border-[#D97706]'
                )}
              >
          ...
          {activeTab === 'voice' && (
            <div className="text-center py-8">
              ...
              <button className="px-6 py-2.5 bg-[#DC2626] text-white rounded-full text-sm font-medium hover:bg-[#B91C1C]">
                Start Recording
              </button>
            </div>
          )}
